...
var GitBashExecutor = class extends LocalBashExecutor {
	static Config = LocalBashExecutor.Config.set("bashPath", z.string()).set("sandbox", z.union([z.const("auto"), z.const("none")]).default("auto")).set("probeTimeoutMs", z.natural().default(1e4));
